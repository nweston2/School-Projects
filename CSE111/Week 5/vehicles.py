def main():
    ...
    if vin in vehicles_dict:
        ...
        nwvalue = vehicles_dict[vin]

        nwmanufacturer = vehicles_dict[vin][MANUFACTURER_INDEX]
        nwmodel = nwvalue[MODEL_INDEX]
        nwcolor = nwvalue[COLOR_INDEX]

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        print(f"{nwmanufacturer} {nwmodel} {nwcolor}")
